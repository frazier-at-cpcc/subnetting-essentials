...
Total Subnets = 4 + 1 = 5 subnets.
Number of Host Addresses Needed in Largest Subnet:
The largest group (Sales) needs 185 hosts. With 25% growth, this increases to 231.
Total Number of Addresses Needed for the Largest Subnet:
After rounding, the largest subnet needs 256 addresses (using a /24 subnet mask).
IP Address Ranges:
...
Use 172.16.1.192/30.
This is a general outline for how to approach the problem based on the image. Let me know if you'd like more specific details or further clarification on any part of this.